...
HD_PWD='I:/4730/project3/v1/v1.runs/mult_multiply_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mult_multiply_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mult_multiply_0_0.tcl
