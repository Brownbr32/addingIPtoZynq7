...
HD_PWD='I:/4730/project3/v1/v1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mult_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mult_wrapper.tcl
